...
#ifndef OPEN_MANIPULATOR_P_CONTROLLER_HPP
#define OPEN_MANIPULATOR_P_CONTROLLER_HPP
...
class OpenManipulatorPController : public rclcpp::Node
{
  ...
  *****************************************************************************/
  rclcpp::Publisher<open_manipulator_msgs::msg::OpenManipulatorState>::SharedPtr open_manipulator_p_states_pub_;
  std::vector<rclcpp::Publisher<open_manipulator_msgs::msg::KinematicsPose>::SharedPtr> open_manipulator_p_kinematics_pose_pub_;
  rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr open_manipulator_p_joint_states_pub_;
  std::vector<rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr> gazebo_goal_joint_position_pub_;

  void publish_open_manipulator_p_states();
  ...
  *****************************************************************************/
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr open_manipulator_p_option_sub_;

  void open_manipulator_p_option_callback(const std_msgs::msg::String::SharedPtr msg);
...
#endif //OPEN_MANIPULATOR_CONTROLLER_HPP
