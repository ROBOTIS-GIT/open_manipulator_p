...
OpenManipulatorProControllerMoveit::~OpenManipulatorProControllerMoveit() {}

/********************************************************************************
** Init Functions
********************************************************************************/
void OpenManipulatorProControllerMoveit::init_publisher()
{
  moveit_update_start_state_pub_ = node_handle_.advertise<std_msgs::Empty>("rviz/moveit/update_start_state", 10);
}

void OpenManipulatorProControllerMoveit::init_subscriber()
{
  display_planned_path_sub_ = node_handle_.subscribe("/move_group/display_planned_path", 100,
                                                      &OpenManipulatorProControllerMoveit::displayPlannedPathCallback, this);
  move_group_goal_sub_ = node_handle_.subscribe("/move_group/goal", 100,
                                                      &OpenManipulatorProControllerMoveit::moveGroupGoalCallback, this);
  execute_trajectory_goal_sub_ = node_handle_.subscribe("/execute_trajectory/goal", 100,
                                                      &OpenManipulatorProControllerMoveit::executeTrajGoalCallback, this);
}

void OpenManipulatorProControllerMoveit::init_server()
{
  get_joint_position_server_  = priv_node_handle_.advertiseService("moveit/get_joint_position", &OpenManipulatorProControllerMoveit::get_joint_position_msg_callback, this);
  get_kinematics_pose_server_ = priv_node_handle_.advertiseService("moveit/get_kinematics_pose", &OpenManipulatorProControllerMoveit::get_kinematics_pose_msg_callback, this);
  set_joint_position_server_  = priv_node_handle_.advertiseService("moveit/set_joint_position", &OpenManipulatorProControllerMoveit::set_joint_position_msg_callback, this);
  set_kinematics_pose_server_ = priv_node_handle_.advertiseService("moveit/set_kinematics_pose", &OpenManipulatorProControllerMoveit::set_kinematics_pose_msg_callback, this);
}

/*****************************************************************************
** Callback Functions for ROS Subscribers
*****************************************************************************/
void OpenManipulatorProControllerMoveit::displayPlannedPathCallback(const moveit_msgs::DisplayTrajectory::ConstPtr &msg)
{
...
void OpenManipulatorProControllerMoveit::moveGroupGoalCallback(const moveit_msgs::MoveGroupActionGoal::ConstPtr &msg)
{
...
void OpenManipulatorProControllerMoveit::executeTrajGoalCallback(const moveit_msgs::ExecuteTrajectoryActionGoal::ConstPtr &msg)
{
  log::println("[INFO] [OpenManipulator Controller] Execute Moveit planned path", "GREEN");
  moveit_plan_state_ = true;
}
...
*****************************************************************************/
void OpenManipulatorProControllerMoveit::get_joint_position_msg_callback(
...
void OpenManipulatorProControllerMoveit::get_kinematics_pose_msg_callback(
  const std::shared_ptr<rmw_request_id_t> request_header,
...
void OpenManipulatorProControllerMoveit::set_joint_position_msg_callback(
  const std::shared_ptr<rmw_request_id_t> request_header,
...
void OpenManipulatorProControllerMoveit::set_kinematics_pose_msg_callback(
  const std::shared_ptr<rmw_request_id_t> request_header,
...
bool OpenManipulatorProControllerMoveit::calc_planned_path(const std::string planning_group, open_manipulator_msgs::msg::KinematicsPose msg)
{
  // rclcpp::AsyncSpinner spinner(1);
  // spinner.start();
...
bool OpenManipulatorProControllerMoveit::calc_planned_path(const std::string planning_group, open_manipulator_msgs::msg::JointPosition msg)
{
  // rclcpp::AsyncSpinner spinner(1);
  // spinner.start();
...
********************************************************************************/
void OpenManipulatorProControllerMoveit::moveitTimer(double present_time)
{
