...
{
 public:
  OpenManipulatorProControllerMoveit(std::string usb_port, std::string baud_rate);
  ~OpenManipulatorProControllerMoveit();
...
#endif //OPEN_MANIPULATOR_PRO_CONTROLLER_MOVEIT_HPP
